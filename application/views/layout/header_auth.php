                ...
                <nav id="main-navbar" class="navbar bg-dark navbar-expand-lg w-100">
                    ...
                    <div class="navbar-collapse collapse" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-secondary" href="<?php echo base_url('auth/create_user');?>">Registrace - level 2</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-secondary" href="<?php echo base_url('auth/create_user');?>">Registrace - level 3</a>
                            </li>
                            <li class="nav-item">
